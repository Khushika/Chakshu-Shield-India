...
import { Share, Twitter, Facebook, MessageCircle, Copy, Mail } from "lucide-react";
...
const SocialShare = () => {
  ...
  const shareContent = {
    ...
    description: "Protecting India from digital fraud through community action. Report scams, share alerts, save lives.",
    url: window.location.origin,
    hashtags: "#FraudPrevention #DigitalIndia #CyberSafety #CommunityProtection"
  };
    ...
    <section>
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Help us reach more people and build a safer digital India. Share fraud prevention awareness with your network.
        </p>
      </div>
