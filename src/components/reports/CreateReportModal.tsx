...
const CreateReportModal = ({ open, onOpenChange, onReportCreated }: CreateReportModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const reportData: any = {
        ...
        amount_involved: formData.amount_involved ? parseFloat(formData.amount_involved) : null
      };
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select value={formData.fraud_type} onValueChange={(value) => handleInputChange('fraud_type', value)}>
                <SelectTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange('amount_involved', e.target.value)}
                placeholder="0.00"
                min="0"
                step="0.01"
              />
